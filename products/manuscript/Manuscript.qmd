...
```{r, echo=FALSE, message=FALSE}
# Load data
hot100_processed <- read.csv("../../data/processed-data/Hot_100_Processed.csv")
...
I expanded on the idea of the Percentage of Main Genres Over Time graph seen above by splitting each genre into their own graph for better visibility.

Total Counts of Main Genres Over Time - Separated:

![](images/genreovertimeplot.png)

This graph more clearly shows the trends of each genre over time.
